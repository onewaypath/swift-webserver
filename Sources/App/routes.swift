...
public func routes(_ router: Router) throws {
    ...
    router.get("deploy") { req -> String in
        ...
        let serverDir = "/home/ayoung/onewaypath.com"
    ...
    router.get("cfonts", String.parameter) { req -> Future<Response> in
           //let root = unixTools().runUnix("pwd")
        let file = try req.parameters.next(String.self)
    ...
    router.get("buddhavipassana", "cfonts", String.parameter) { req -> Future<Response> in
           //let root = unixTools().runUnix("pwd")
        let file = try req.parameters.next(String.self)
    ...
    router.get("on-num", "cfonts", String.parameter) { req -> Future<Response> in
           //let root = unixTools().runUnix("pwd")
        let file = try req.parameters.next(String.self)
